...
const { Vector3, Matrix4, BufferGeometry, Quaternion, Box3 } = THREE
...
// export const createHeightfieldTerrainShape = function (root, options) {
     ...
     * @param {String}[ options.fit = FIT.MANUAL] 
     * @param {Number}[ options.heightfieldDistance = 1]  总放大的宽高
     * @param {[]}[ options.heightfieldData = [] ]   地形高度数组
     * @param {String}[ options.heightDataType = Ammo.PHY_FLOAT ] 
     * @param {Number}[ options.heightScale = 0] 
     * @param {Number}[ options.upAxis = 1] 
     * @param {Boolean}[ options.flipQuadEdges = true] 
     * @returns {Ammo.shapes}
     */
